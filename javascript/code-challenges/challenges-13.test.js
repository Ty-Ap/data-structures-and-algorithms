...
for example ['','q','qw','qwe','saghnet'] returns 4
------------------------------------------------------------------------------------------------ */
...
function firstLetters(strings) {
  let firstLettersArr = [];
  for (let i = 0; i < strings.length; i++) {
    firstLettersArr.push(strings[i][0]);
  }
...
function findHappiness(strings) {
  let happyStrings = [];
  for (let i = 0; i < strings.length; i++) {
    if (strings[i].includes(':)')) {
      happyStrings.push(strings[i]);
    }
  }
  return happyStrings;
}
...
function standardizePhoneNumbers(numbers) {
  let standardizedNumbers = [];
  for (let i = 0; i < numbers.length; i++) {
    standardizedNumbers.push(numbers[i].replace(/[() -]/g, ''));
  }
