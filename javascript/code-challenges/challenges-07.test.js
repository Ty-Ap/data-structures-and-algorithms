...
function sortStarWarsCharacters(starWarsPeople) {
  return starWarsPeople.sort(compare);

}

// const sortStarWarsCharacters = (starWarsArr) => {
//   starWarsArr.height.sort(compare);
// };
...
sounds like .reduce();  remove first 3
------------------------------------------------------------------------------------------------ */
